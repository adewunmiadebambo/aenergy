...
<html lang="en">
<head>
<title>Technical Consultancy | Africa Energy Solutions Limited</title>
...
<!-- inner page banner -->
<section class="inner_page_banner text-center pt-4" style="background: url(./images/cob.jpg) no-repeat 0px 0px;>
        ...
        <div class="container">
            ...
            <div class="row page-content" style="margin-bottom: 30px;">
                <div class="col-md-12" style="padding-right: 50px;">
					...
					<p style="padding-top: 60px;"><div class="my-big-text">  <img src="images/cons.jpg">
					<h1 class="text-uppercase" style="padding-top: 20px;">Technical Consultancy</h1><br>
